...
- The sign of the covariance helps to determine the relationship between two components:  
  ...
  NB: Correlation coefficient$$ \rho_ {ij} = \frac{\sigma_{ij}}{\sqrt{\sigma_{ii}\sigma_{jj}} \quad\quad (−1 ≤ \rho{ij} ≤ 1)$$
...
$$\mu = 
  ...
  NB: Correlation coefficient $$ \rho_ {ij} = \frac{\sigma_{ij}}{\sqrt{\sigma_{ii}\sigma_{jj}} \quad\quad (−1 \leq \rho{ij} \leq 1)$$
